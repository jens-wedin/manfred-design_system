...
<head>
    <title>Code coverage report for Code/manfred-design_system/src/components/Checkbox/Checkbox.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">Code/manfred-design_system/src/components/Checkbox</a> Checkbox.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
  useEffect(() =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (inputRef.current) {
